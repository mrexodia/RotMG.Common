...
namespace RotMG.Common.Networking.Packets
{
    ...
    public class PacketOTHERHIT : Packet
    {
        ...
        public static void InitIO()
        {
            ...
            {
                init.Field<int>((PacketOTHERHIT p) => p.Time, FieldType.Int32).Field<byte>((PacketOTHERHIT p) => p.BulletId, FieldType.Byte).Field<int>((PacketOTHERHIT p) => p.ObjectId, FieldType.Int32).Field<int>((PacketOTHERHIT p) => p.TargetId, FieldType.Int32).End();
            });
        }
    }
}
